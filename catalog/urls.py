...
urlpatterns += [
    ...
    path(
        ...
        views.return_book_librarian,
        name="return-book-librarian",
    ),
]
...
urlpatterns += [
    ...
    path(
        "language/<int:pk>", views.LanguageDetailView.as_view(), name="language-detail"
    ),
    path("language/create/", views.LanguageCreate.as_view(), name="language-create"),
    path(
        "language/<int:pk>/update/",
        views.LanguageUpdate.as_view(),
